...
def build_web_tool_routing_prompt() -> PromptSection:
    ...
    content = (
        ...
        "- Seriality: issue at most one OpenCLI command per model response/tool batch and await it. Never run "
        "OpenCLI and `browser_agent` concurrently for the same operation.\n"
