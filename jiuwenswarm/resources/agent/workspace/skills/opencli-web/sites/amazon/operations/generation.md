...
|---|---|---|---|---|
| `new-releases` | `disabled` | `quota_consumption` / `high` | Not executable; use the declared fallback if permitted<br>Amazon New Releases pages for early momentum discovery | `input` (str, optional, positional); `limit` (int, optional, default=100) |
