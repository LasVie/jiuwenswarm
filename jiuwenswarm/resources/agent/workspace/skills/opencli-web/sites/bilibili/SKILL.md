...
| `private-content` | Read content that depends on an authenticated account. | `comments`, `dynamic`, `feed`, `feed-detail`, `following`, `history`, `hot`, `ranking`, `search`, `subtitle`, `summary`, `user-videos`, `video` | `sites/bilibili/operations/private-content.md` |
