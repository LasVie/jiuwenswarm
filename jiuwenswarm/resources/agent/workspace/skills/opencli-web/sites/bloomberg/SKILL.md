---
name: opencli-bloomberg
description: Route reviewed Bloomberg website operations through the OpenCLI Web structured execution boundary.
---

# Bloomberg

Catalog site slug: `bloomberg`.
 Known domains: `feeds.bloomberg.com`, `www.bloomberg.com`.
