...
| `private-content` | Read content that depends on an authenticated account. | `chatlist`, `chatmsg`, `detail`, `joblist`, `recommend`, `resume`, `search`, `stats` | `sites/boss/operations/private-content.md` |
