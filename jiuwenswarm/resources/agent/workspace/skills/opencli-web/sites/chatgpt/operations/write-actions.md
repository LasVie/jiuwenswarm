...
|---|---|---|---|---|
| `model` | `reversible_remote_write` / `high` | `opencli chatgpt model "<fast\|speed\|instant\|极速\|balanced\|balance\|medium\|均衡\|advanced\|high\|thinking\|高级\|very-high\|ultra\|xhigh\|x-high\|extra-high\|超高\|pro\|professional\|专业>" [--project "<project>"] -f json`<br>Switch ChatGPT web intelligence level (fast, balanced, advanced, very-high, pro) | `model` (str, required, positional, choices=fast,speed,instant,极速,balanced,balance,medium,均衡,advanced,high,thinking,高级,very-high,ultra,xhigh,x-high,extra-high,超高,pro,professional,专业); `project` (str, optional) | auth=required; transport=browser_cookie; fallback_before=browser_agent; fallback_after=none |
