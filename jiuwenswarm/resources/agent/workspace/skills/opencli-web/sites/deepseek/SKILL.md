...
|---|---|---|---|
| `account` | Read account identity or account-scoped metadata. | `whoami` | `sites/deepseek/operations/account.md` |
...
| `private-content` | Read content that depends on an authenticated account. | `detail`, `history`, `read`, `status` | `sites/deepseek/operations/private-content.md` |
