...
|---|---|---|---|---|
| `send` | `disabled` | `message_send` / `high` | Not executable; use the declared fallback if permitted<br>Send a message to Doubao web chat | `text` (str, required, positional) |
