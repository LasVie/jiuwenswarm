...
| `discovery` | Search, browse, recommend, or discover site content. | `location`, `search`, `user-videos` | `sites/douyin/operations/discovery.md` |
| `private-content` | Read content that depends on an authenticated account. | `activities`, `collections`, `drafts`, `hashtag`, `stats`, `videos` | `sites/douyin/operations/private-content.md` |
