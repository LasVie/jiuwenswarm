...
|---|---|---|---|
| `account` | Read account identity or account-scoped metadata. | `whoami` | `sites/grok/operations/account.md` |
...
| `file-operations` | Create or download workspace files. | `export`, `export-all` | `sites/grok/operations/file-operations.md` |
...
| `private-content` | Read content that depends on an authenticated account. | `detail`, `history`, `read`, `status` | `sites/grok/operations/private-content.md` |
