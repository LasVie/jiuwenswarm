...
|---|---|---|---|---|
| `pin` | `disabled` | `reversible_remote_write` / `high` | Not executable; use the declared fallback if permitted<br>Pin a Grok conversation by ID | `id` (string, required, positional) |
