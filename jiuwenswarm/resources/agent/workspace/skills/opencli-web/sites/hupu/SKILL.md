...
| `content` | Read one public item, record, page, or resource. | `detail` | `sites/hupu/operations/content.md` |
| `discovery` | Search, browse, recommend, or discover site content. | `hot`, `search` | `sites/hupu/operations/discovery.md` |
| `messaging` | Send messages, replies, comments, invitations, or contacts. | `reply` | `sites/hupu/operations/messaging.md` |
| `private-content` | Read content that depends on an authenticated account. | `mentions` | `sites/hupu/operations/private-content.md` |
