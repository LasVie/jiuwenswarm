...
|---|---|---|---|---|
| `like` | `disabled` | `reversible_remote_write` / `high` | Not executable; use the declared fallback if permitted<br>点赞虎扑回复 (需要登录) | `tid` (str, required, positional); `pid` (str, required, positional); `fid` (str, required) |
