...
|---|---|---|---|
| `account` | Read account identity or account-scoped metadata. | `whoami` | `sites/instagram/operations/account.md` |
...
| `content` | Read site content and metadata. | `profile` | `sites/instagram/operations/content.md` |
...
| `discovery` | Search, browse, recommend, or discover site content. | `explore`, `search` | `sites/instagram/operations/discovery.md` |
...
| `private-content` | Read content that depends on an authenticated account. | `followers`, `following`, `saved`, `user` | `sites/instagram/operations/private-content.md` |
