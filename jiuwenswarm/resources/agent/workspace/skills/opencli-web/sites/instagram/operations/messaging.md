...
|---|---|---|---|---|
| `comment` | `disabled` | `message_send` / `high` | Not executable; use the declared fallback if permitted<br>Comment on an Instagram post | `username` (str, required, positional); `text` (str, required, positional); `index` (int, optional, default=1) |
