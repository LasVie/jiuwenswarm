...
|---|---|---|---|---|
| `comment` | `disabled` | `message_send` / `high` | Not executable; use the declared fallback if permitted<br>评论即刻帖子 | `id` (string, required, positional); `text` (string, required, positional) |
