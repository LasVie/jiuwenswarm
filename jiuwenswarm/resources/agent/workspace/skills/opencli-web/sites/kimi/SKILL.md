...
|---|---|---|---|
| `account` | Read account identity or account-scoped metadata. | `account`, `whoami` | `sites/kimi/operations/account.md` |
...
| `private-content` | Read content that depends on an authenticated account. | `cookies`, `detail`, `history`, `idb-list`, `read`, `status`, `storage-get`, `storage-keys`, `templates`, `usage` | `sites/kimi/operations/private-content.md` |
