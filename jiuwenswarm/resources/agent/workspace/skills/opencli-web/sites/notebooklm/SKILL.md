...
|---|---|---|---|
| `account` | Read account identity or account-scoped metadata. | `whoami` | `sites/notebooklm/operations/account.md` |
...
| `private-content` | Read content that depends on an authenticated account. | `current`, `get`, `history`, `list`, `note-list`, `notes-get`, `open`, `source-fulltext`, `source-get`, `source-guide`, `source-list`, `status`, `summary` | `sites/notebooklm/operations/private-content.md` |
