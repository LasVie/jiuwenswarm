...
|---|---|---|---|---|
| `search` | `disabled` | `public_read` / `low` | Not executable; use the declared fallback if permitted<br>搜索中国电建阳光采购公告 | `query` (str, required, positional); `limit` (int, optional, default=20) |
