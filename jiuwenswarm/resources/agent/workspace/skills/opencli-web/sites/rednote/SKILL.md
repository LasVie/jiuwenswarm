...
| `private-content` | Read content that depends on an authenticated account. | `comments`, `feed`, `note`, `notifications`, `search`, `user` | `sites/rednote/operations/private-content.md` |
