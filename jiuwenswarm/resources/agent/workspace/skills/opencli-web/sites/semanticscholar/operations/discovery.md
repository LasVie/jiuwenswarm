...
|---|---|---|---|---|
| `search` | `enabled` | `public_read` / `low` | `opencli_execute(site="semanticscholar", operation="discovery", command="search", arguments={"query":"<query>"})`<br>Search Semantic Scholar papers by free text | `query` (str, required, positional); `limit` (int, optional, default=20) |
