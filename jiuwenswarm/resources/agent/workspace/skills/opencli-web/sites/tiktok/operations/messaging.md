...
|---|---|---|---|---|
| `comment` | `disabled` | `message_send` / `high` | Not executable; use the declared fallback if permitted<br>Post a comment on a TikTok video | `url` (str, required, positional); `text` (str, required, positional) |
