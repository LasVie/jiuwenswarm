...
|---|---|---|---|
| `account` | Read account identity or account-scoped metadata. | `whoami` | `sites/twitter/operations/account.md` |
...
| `content` | Read one public item, record, page, or resource. | `article`, `profile`, `thread`, `tweets` | `sites/twitter/operations/content.md` |
