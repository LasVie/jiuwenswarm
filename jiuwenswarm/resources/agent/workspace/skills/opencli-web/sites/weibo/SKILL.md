...
| `private-content` | Read content that depends on an authenticated account. | `comments`, `favorites`, `feed`, `hot`, `post`, `search`, `user`, `user-posts` | `sites/weibo/operations/private-content.md` |
