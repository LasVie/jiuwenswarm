...
|---|---|---|---|---|
| `delete` | `disabled` | `destructive_or_admin` / `critical` | Not executable; use the declared fallback if permitted<br>Delete one of my Weibo posts by id | `id` (str, required, positional) |
