...
| `file-operations` | Create or download workspace files. | `transcript` | `sites/youtube/operations/file-operations.md` |
| `private-content` | Read content that depends on an authenticated account. | `channel`, `comments`, `feed`, `history`, `playlist`, `search`, `subscriptions`, `video`, `watch-later` | `sites/youtube/operations/private-content.md` |
