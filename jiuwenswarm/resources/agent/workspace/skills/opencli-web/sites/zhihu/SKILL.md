...
| `content` | Read one public item, record, page, or resource. | `answer-comments`, `answer-detail`, `question`, `user` | `sites/zhihu/operations/content.md` |
| `discovery` | Search, browse, recommend, or discover site content. | `followers`, `following`, `hot`, `pins`, `search`, `user-answers`, `user-articles` | `sites/zhihu/operations/discovery.md` |
...
| `private-content` | Read content that depends on an authenticated account. | `collection`, `collections`, `recommend` | `sites/zhihu/operations/private-content.md` |
